...
namespace SaveOurShip2
{
	...
	{
		public const string AntiBoardingFullyGeneratedPattern = "Angit-boarding defenses fully generated for ship";
		public static readonly string AntiBoardingFullyGenerated = AntiBoardingFullyGeneratedPattern + ": {0}";

		public const string AntiBoardingPartiallyGeneratedPattern = "Angit-boarding defenses partially generated for ship";
		public static readonly string AntiBoardingPartiallyGenerated = AntiBoardingPartiallyGeneratedPattern + ": {0}";

		public const string AntiBoardingNotGeneratedPattern = "Angit-boarding defenses not generated for ship";
