...
namespace SaveOurShip2
{
	...
	public static class DialogOptionGetter_StashedShip
	{
		...
		public static void AddOptionsToNode(ref DiaNode dialogNode)
		{
			...
			{
				if (IsSpecificOptionUnvailable(SilverCost, out unavailableOption))
				{
					dialogNode.options.Add(unavailableOption);
				}
				else
		...
		private static bool IsSpecificOptionUnvailable(int shipSilverCost, out DiaOption unavailableOption)
		{
