	...
	class JobDriver_HackSatellite : JobDriver
	{
		...
		protected override IEnumerable<Toil> MakeNewToils()
		{
			...
			hackIt.AddFinishAction(delegate {
				if (workDone >= WorkAmount - JobUtility.WorkFinishThreshold && pawn.health.State == PawnHealthState.Mobile && TargetA.HasThing && !TargetA.Thing.DestroyedOrNull() && TargetA.Thing is Building_SatelliteCore)
				{
