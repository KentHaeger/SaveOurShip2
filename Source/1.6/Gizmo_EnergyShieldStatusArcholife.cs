...
namespace SaveOurShip2
{
	...
	public class Gizmo_EnergyShieldStatusArcholife : Gizmo
	{
		...
		public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
		{
			...
			Widgets.Label(rect3, "SoS.EnergyShieldStatusLabel".Translate());
			Rect rect4 = rect2;
			...
			Widgets.Label(rect4, "SoS.EnergyShieldStatusDesc".Translate((shield.Energy * 100f).ToString("F0"), (((CompProps_Archolife)shield.props).shield * 100f).ToString("F0")));
